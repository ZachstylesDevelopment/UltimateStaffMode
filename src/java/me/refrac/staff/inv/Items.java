...
public class Items
{
    ...
    public static ItemStack Glass(Player p) {
        ItemStack stone = new ItemStack(Material.WHITE_STAINED_GLASS_PANE, 1, (short)7);
        ItemMeta stonem = stone.getItemMeta();
    ...
    public static ItemStack SIXAM(Player p) {
        ItemStack stone = new ItemStack(Material.BLUE_WOOL);
        ItemMeta stonem = stone.getItemMeta();
    ...
    public static ItemStack TOOLS(Player p) {
        ItemStack stone = new ItemStack(Material.COMMAND_BLOCK);
        ItemMeta stonem = stone.getItemMeta();
    ...
    public static ItemStack EFFECTS(Player p) {
        ItemStack stone = new ItemStack(Material.BREWING_STAND);
        ItemMeta stonem = stone.getItemMeta();
    ...
    public static ItemStack MobMenu(Player p) {
        ItemStack stone = new ItemStack(Material.SPAWNER);
        ItemMeta stonem = stone.getItemMeta();
    ...
    public static ItemStack BlindnessTroll(Player p) {
        ItemStack stone = new ItemStack(Material.INK_SAC);
        ItemMeta stonem = stone.getItemMeta();
        ArrayList<String> lore = new ArrayList <>();
        lore.add(ChatColor.YELLOW + "(Give blindness to all players!)");
        lore.add(ChatColor.AQUA + "(Lasts FOREVER!)");
        stonem.setLore(lore);
